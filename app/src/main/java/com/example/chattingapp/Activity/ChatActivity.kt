...
class ChatActivity : AppCompatActivity()
{
    ...
    public fun sendMessage(senderId: String, receiverId: String, message: String)
    {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (dataSnapShot: DataSnapshot in snapshot.children) {
                    ...
                    if (chat !!.senderId.equals(senderId) && chat.receiverId.equals(receiverId) ||
                        ...
                        //chat.set(dataSnapShot.key)
                        chatList.add(chat)
                    }
                }
                val chatAdapter = ChatAdapter(this@ChatActivity, chatList, receiverId)
                val cv = findViewById<RecyclerView>(R.id.chatRecyclerView)
        ...
        when(item.itemId)
        {
            ...
            R.id.audiocall ->
            {
                    ...
                    Alerter.create(this)
                            .setTitle("Calling...")
                            .setText(userName)
                            .setIcon(R.drawable.ic_baseline_call)
